    ...
    <div class="col-md-6">
        ...
        <div class="form-style-10 ">
            <h1>Demande de devis de traduction<span>demander votre devis facilement en remplissant ce
                            formulaire</span></h1>
            <form id="traduction_forme" type="post" enctype="multipart/form-data">



                <div class="section"><span>1</span>détaille sur la traduction</div>
                <div class="inner-wrap">
                    <?= FH::inputBlock('text','Langue origine','nom',$this->devis->lang_src,['class'=>'form-control input-sm'],['class'=>'form-group']) ?>
