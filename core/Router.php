<?php
  ...
  class Router {
    ...
    public static function route($url) {
      ...
      //action the default action if we didn't specify it is indexAction
      ...
      //dispatch call a specific controller which inherit from the contoller which will cal the associated View
